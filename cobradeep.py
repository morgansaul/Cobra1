...
class DEXScanner:
        ...
        for endpoint in endpoints:
            try:
                ...
                if (w3.is_connected() and
                    ...
                    print(f"[✓] Connected to {self.chain} (ChainID: {chain_id}) via {endpoint}")
                    return w3
    ...
    async def _scan_contract_addresses(self):
        ...
        if self.deep_scan and matches:
            print("[•] Validating addresses on-chain...")
        ...
        for address in addresses:
            if self._validate_contract_address(address):
                try:
                    ...
                    print(f"[!] Slither failed for {address}: {str(e)[:100]}")
...
def print_banner():
    ...
    ██████╔╝███████╗██╔╝ ██╗    ███████╗╚██████╗╚██████╔╝██║  ██║███████╗
    ╚═════╝ ╚══════╝╚═╝  ╚═╝    ╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝
    DEX Security Scanner v3.0 | Advanced Financial Risk Detection
    """)
